...
control_info_bus = Simulink.Bus;
control_info_bus.Description = '';
control_info_bus.DataScope = 'Auto';
control_info_bus.HeaderFile = '';
control_info_bus.Alignment = -1;
control_info_bus.PreserveElementDimensions = false;
...
control_info_bus.Elements = saveVarsTmp{1};
clear saveVarsTmp;
